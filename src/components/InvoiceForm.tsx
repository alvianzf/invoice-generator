        ...
        if (item.id === id) {
          ...
          if (
            ...
            const quantity = parseFloat(
              updatedItem.quantity.replace(/[^0-9.-]+/g, "")
            );
            const price = parseFloat(
              updatedItem.price.replace(/[^0-9.-]+/g, "")
            );
          ...
          <div className="space-y-3 mb-6">
            ...
            <div>
              ...
              <input
                ...
                onChange={handleInputChange}
                placeholder="e.g. Jakarta Utara, Indonesia"
                className="w-full rounded-md border border-gray-600 bg-gray-700 px-3 py-2 text-sm text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>
            <div>
        ...
        <table className="w-full border-collapse">
          <thead>
            <tr className="bg-gray-700">
              <th className="border border-gray-600 px-4 py-2 text-left text-sm font-medium text-gray-200">
                Description
              </th>
              <th className="border border-gray-600 px-4 py-2 text-left text-sm font-medium text-gray-200 w-32">
                Quantity
              </th>
              <th className="border border-gray-600 px-4 py-2 text-left text-sm font-medium text-gray-200 w-40">
                Price
              </th>
              <th className="border border-gray-600 px-4 py-2 text-left text-sm font-medium text-gray-200 w-40">
                Amount
              </th>
              <th className="border border-gray-600 px-4 py-2 text-center text-sm font-medium text-gray-200 w-16">
                Action
              </th>
            </tr>
          </thead>
